...
// Working Image Links (No local file errors)
...
export default function Home() {
  const startRileyCall = () => {
    if (window && (window as any).vapiSDK) {
      ...
      alert("Riley AI load ho rahi hai!");
    }
  };

  const products = [
    { img: product1, title: "Rice Husk Plate", price: "₹199", desc: "100% Natural essentials." },
    { img: product2, title: "Eco-Container", price: "₹249", desc: "Airtight Storage." },
    { img: product3, title: "Earth Cup", price: "₹149", desc: "Heat Resistant." },
    { img: product4, title: "Bio Tumbler", price: "₹299", desc: "Zero Plastic." }
  ];
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] flex flex-col overflow-x-hidden">
      ...
      <main className="flex-grow pt-16">
        ...
        <section id="product" className="py-20 max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
          {products.map((p, i) => (
